  ...
  res = foreach (abs.simulParam = abs.simulParams) %do%
    {
      ...
      if (doRichness)
      {
        ...
        .unzip(folder_name = GLOB_DIR$dir.output.perPFG.allStrata.BIN
      ...
      year_list = foreach (y = years) %do%
        {
          ...
          if (opt.doPlot)
          {
            ...
            {
              cat("\n> PFG richness...")
              ras.pts = as.data.frame(rasterToPoints(ras.SR))
            ...
            ## PFG CWM LIGHT --------------------------------------------------------
            if (doCWM && GLOB_SIM$doLight && exists("ras.CWM.light"))
            {
              cat("\n> PFG CWM light...")
            ...
            if (doCWM && GLOB_SIM$doLight && exists("ras.light"))
            {
            ...
            ## PFG CWM SOIL ---------------------------------------------------------
            if (doCWM && GLOB_SIM$doSoil && exists("ras.CWM.soil"))
            {
              cat("\n> PFG CWM soil...")
            ...
            if (doCWM && GLOB_SIM$doSoil && exists("ras.soil"))
            {
