...
- a [`shiny` interface](interface_tutorial_0_presentation.html), and a complete documentation and manual, with meaningful examples from real dataset (see [Manual & Examples](manual.html) page)
