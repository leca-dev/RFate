...
- 1.4.1 :
    ...
    + add `doRichness`, `doCover`, `doLeinster`, `doCWM` parameters in `POST_FATE.graphic_mapPFG` function <br/> + `doRichness` via binary maps directly <br/> + correct the `.zip` step
- 1.4.0 (august) :
