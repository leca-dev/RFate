...
#### Version 1.3.0 (september 2023) <a href="https://raw.githubusercontent.com/leca-dev/RFate/master/data-raw/RFate_1.3.0.tar.gz" class="download" title="Download as tar.gz"><i class="fa-solid fa-download"></i></a>

- addition of `LIGHT_RECRUIT` parameter within `LIGHT` module, and `--SOIL_MASK--`, `SOIL_FILL_MAP` and `SOIL_RECRUIT` parameters within `SOIL` module (see [FATE tutorial - Modules](fate_tutorial_3_MODULES.html))
