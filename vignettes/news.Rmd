...
#### Version 1.1.0 (may 2022) <a href="https://raw.githubusercontent.com/leca-dev/RFate/master/data-raw/RFate_1.1.0.tar.gz" class="download" title="Download as tar.gz"><i class="fas fa-download"></i></a>

- addition of `SHADE_FACTOR` parameter within `LIGHT` module (see [FATE tutorial - Modules](fate_tutorial_3_MODULES.html))
- corrections to seeding recruitment


#### Version 1.0.0 (june 2021) <a href="https://raw.githubusercontent.com/leca-dev/RFate/master/data-raw/RFate_1.0.0.tar.gz" class="download" title="Download as tar.gz"><i class="fas fa-download"></i></a>
