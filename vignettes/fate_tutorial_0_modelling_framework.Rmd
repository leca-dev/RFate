...
- **Interaction through <i class="fas fa-sun"></i> light and/or <i class="fas fa-recycle"></i> soil resources** regulates interactions between cohorts affecting germination, recruitment and survival.
