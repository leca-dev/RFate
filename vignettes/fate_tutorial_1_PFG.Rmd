...
## <i class="fas fa-search"></i> Example of data required ?
...
- Age at maturity
- Longevity
- Raunkiaer's life forms (Raunkiaer 1934)
- Height to represent a proxy for biomass

#### Dispersal ability

- Dispersal classes (Vittoz & Engler 2007)

#### Response to interactions

- Height to represent the competitive ability for light
- Indicator value for light requirement (Ellenberg et al. 1991, Landolt et al. 2010)
- Indicator value for soil requirement (Ellenberg et al. 1991, Landolt et al. 2010)

#### Response to disturbances

- For grazing : palatability index based on pastoral values (Jouglet 1999)
